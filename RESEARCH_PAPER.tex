...
\midrule
        ...
        \texttt{fuzz_lab17_kernel_kcov} & 405 & 98.9/s & 3 & \textbf{1} & 28.12% \\
        \texttt{fuzz_lab19_unicorn_firmware} & 368 & 141.2/s & 2 & \textbf{1} & 26.32% \\
        \texttt{fuzz_lab2} & 108,257 & 489.8/s & 45 & \textbf{0} & 53.57% \\
        \texttt{fuzz_lab2} & 1,231,602 & 464.4/s & 46 & \textbf{6} & 57.14% \\
        \texttt{fuzz_lab20_stateful_network} & 184 & 74.5/s & 1 & \textbf{1} & 36.36% \\
        \texttt{fuzz_lab21_wasm_jit} & 136 & 70.9/s & 4 & \textbf{1} & 37.50% \\
        \texttt{fuzz_lab22_distributed_cluster} & 231 & 122.6/s & 2 & \textbf{1} & 12.50% \\
